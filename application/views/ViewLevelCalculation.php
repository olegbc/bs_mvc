<div class="wrapper_level_culc">
    <form name="level_culc" action="javascript:void(null);" method="post" onsubmit="level_culc_fn()" id="level_culc">
        ...
        <div class="formField"><input type="text" name="timetable_choose" id="timetable_choose"  /><label for="timetable_choose" >Расписание*</label></div>
        <div class="formField"><input type="checkbox" name="intensive_choose" id="intensive_choose" /><label for="intensive_choose" >Интенсив</label></div>
        <input type="submit" />
    </form>
</div>
